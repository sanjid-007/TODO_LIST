...
router.get("/view", verify, (req, res) => {
    mysqlConnection.query("SELECT * FROM notetaker", (err, rows, fields) => {
...
router.post("/create", verify, (req, res) => {
    mysqlConnection.query(
        "INSERT INTO notetaker (Name, Priority, note) VALUES (?,?,?)",
        [req.body.Name, req.body.Priority, req.body.note], (err, rows, fields) => {
